-- Create secure RPC function for atomic pool match creation
...
BEGIN
  ...
  INSERT INTO pool_matches(
    id, mode, buy_in, rake_pct, status, max_players, current_players,
    created_by, players, table_config, balls, turn_user_id, rules,
