-- Remove TODAS as versões da função create_pool_match_tx de forma mais agressiva
DROP FUNCTION IF EXISTS public.create_pool_match_tx(uuid,public.match_mode,integer,integer,text);
...
-- Cria a função única e definitiva
...
-- Owner/grants para garantir funcionalidade
