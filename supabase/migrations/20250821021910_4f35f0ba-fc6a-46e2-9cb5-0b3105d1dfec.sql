-- 1. Adicionar CHECK constraint para orders.status (se não existir)
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- 2. Criar índices críticos para performance (IF NOT EXISTS previne erro)
...
-- 3. Melhorar função update_order_status para aceitar actor_id opcional
