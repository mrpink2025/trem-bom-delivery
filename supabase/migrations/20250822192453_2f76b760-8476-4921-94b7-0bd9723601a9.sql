...
CREATE TABLE user_suspensions (
  ...
  is_active boolean GENERATED ALWAYS AS (
    (ends_at IS NULL AND now() >= starts_at) OR (now() BETWEEN starts_at AND ends_at)
  ) STORED
);
...
('take_rate_default', '{"percentage": 15.0}', 'Taxa padrão da plataforma (%)', '00000000-0000-0000-0000-000000000000'),
('service_fee', '{"percentage": 2.0}', 'Taxa de serviço (%)', '00000000-0000-0000-0000-000000000000'),
('delivery_margin_target', '{"percentage": 8.0}', 'Margem alvo para delivery (%)', '00000000-0000-0000-0000-000000000000'),
('max_orders_per_hour', '{"value": 100}', 'Máximo de pedidos por hora por loja', '00000000-0000-0000-0000-000000000000'),
('tracking_retention_days', '{"value": 30}', 'Dias de retenção dos dados de tracking', '00000000-0000-0000-0000-000000000000');
