-- Add join_code and improve pool_matches structure
...
BEGIN
  ...
  ELSE
    ...
    BEGIN
      ALTER TYPE pool_match_status ADD VALUE IF NOT EXISTS 'CANCELLED';
    EXCEPTION
...
ALTER TABLE pool_matches 
ALTER COLUMN status TYPE pool_match_status USING status::pool_match_status;
...
-- Allow system operations for match management
...
-- Only creator can update match before it starts
