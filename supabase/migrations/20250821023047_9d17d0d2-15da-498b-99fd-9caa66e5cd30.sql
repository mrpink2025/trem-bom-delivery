-- Correção: Usar índice composto para coordenadas geográficas
-- 1. Adicionar CHECK constraint para orders.status (já foi tentado)
DO $$ 
BEGIN
